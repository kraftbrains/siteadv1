        ...
        <section className="mb-16" id="atuacao">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              <img src="/siteadv1/window.svg" alt="Direito Civil" width={48} height={48} className="mb-4" />
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              <img src="/siteadv1/next.svg" alt="Direito de Família" width={48} height={48} className="mb-4" />
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              <img src="/siteadv1/vercel.svg" alt="Direito do Consumidor" width={48} height={48} className="mb-4" />
